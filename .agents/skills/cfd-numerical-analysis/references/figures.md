# Native Fluent Spatial Figures

Create a figure that answers a scientific question, not a generic screenshot of
the current Fluent session. Use this figure-production branch for experiment
records, analysis handoffs, reviews, or meeting reports; document layout stays
with `report-writing`.
...
Every deliverable figure produced through this branch must be a native Fluent
...
This branch does not render HTML or author the meeting document; document
...
Resolve material choices from the active phase contract. When an unresolved
choice would change scientific scope or needs genuinely human judgement, ask
for it; otherwise record the narrowest assumption and proceed.
