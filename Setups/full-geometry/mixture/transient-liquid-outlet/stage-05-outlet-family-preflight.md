...
| Parent | immutable common `t = 0` parent + method lock from [Stage 4](stage-04-transient-numerical-qualification.md) |
...
Proceed to [Stage 6 — Six-Case Aggressive Retention Screen](stage-06-six-case-screen.md) once the common-method compatibility question is resolved.