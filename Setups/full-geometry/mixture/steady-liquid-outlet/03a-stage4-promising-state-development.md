...
parent-eligible.  See the [execution evidence report](../../../reports/full-geometry/mixture/steady-liquid-outlet/03a/03a-stage4-native-queue-execution-2026-08-23.md).
...
Stage 4 is diagnostic/model-development evidence. It does not establish turbulence-model correctness, mesh independence, plant validation, or separator performance. The initial experiment rationale remains documented in the [Stage-4 brief](../../../reports/full-geometry/mixture/steady-liquid-outlet/03a/03a-stage4-initial-experiment-brief.md).
