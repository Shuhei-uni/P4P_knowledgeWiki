...
The complete relocation map and portable analysis files are now stored beside
this report:

- [Server 2 evidence README](evidence/03a-stage4-server2/README.md) — exact
  remote root, branch/run mapping, file types, and transfer limitation.
- [Machine-readable evidence index](evidence/03a-stage4-server2/index.json) —
  30/30 recovered report histories for S4-01, S4-02, and S4-03.
- [Checkpoint relocation manifest](evidence/03a-stage4-server2/checkpoint-relocation-manifest.json) —
  exact remote case/data paths and existence checks for all checkpoint,
  prepared, endpoint, and forensic artifacts.
- [Plot index](plots/03a-stage4/server2/index.json) — 22 PNGs: seven per
  branch plus one cross-branch comparison.
