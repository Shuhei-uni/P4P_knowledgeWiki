...
def apply_intended_models(solver) -> bool:
    ...
    ok = True
    ok &= try_action("set_multiphase_model", lambda: setattr(models.multiphase, "models", "mixture"))
    ok &= try_action("set_number_of_phases", lambda: setattr(models.multiphase, "number_of_phases", 2))
