...
Use:
    python scripts/setup/setup_vof_ewf_from_existing_case.py --dry-run
    python scripts/setup/setup_vof_ewf_from_existing_case.py --apply --film-walls wall wall-fluid --force
...
from pyansys_fluent.common import remote_chdir, remote_file_exists, safe_get_state, try_action  # noqa: E402
from pyansys_fluent.connection import connect  # noqa: E402
from pyansys_fluent.setup_common import names_from_boundary_state  # noqa: E402
