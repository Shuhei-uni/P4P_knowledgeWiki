...
REPORT_SPECS: tuple[ReportSpec, ...] = (
    ...
    ReportSpec("film_secondary_phase_mass_total", "secondary-phase-mass-total", ("surface-sum", "sum"), (("sum",),), ("film-phase2-mass", "Film Secondary Phase Mass"), (("film", "phase2", "mass"),), "kg", optional_mechanism="phase_accretion"),
    ReportSpec("film_secondary_phase_collection_area_average", "secondary-phase-collection-awavg", ("surface-areaavg", "area-weighted-average"), (("area", "avg"), ("area", "weighted", "average")), ("film-phase2-mass-collection", "Film Secondary Phase Collection Coef"), (("film", "phase2", "mass", "collection"),), "dimensionless", optional_mechanism="phase_accretion"),
    ReportSpec("film_velocity_area_average", "velocity-mag-awavg", ("surface-areaavg", "area-weighted-average"), (("area", "avg"), ("area", "weighted", "average")), ("film-velocity-mag", "film-velocity-magnitude", "Film Velocity Magnitude"), (("film", "velocity", "mag"),), "m/s"),
    ReportSpec("film_velocity_max", "velocity-mag-max", ("surface-facetmax", "facet-maximum", "facet-max"), (("facet", "max"),), ("film-velocity-mag", "film-velocity-magnitude", "Film Velocity Magnitude"), (("film", "velocity", "mag"),), "m/s"),
