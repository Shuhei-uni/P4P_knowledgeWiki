...
def connect(
    ...
    *,
    ...
    start_transcript: bool | None = None,
):
    load_dotenv()
    ...
    if start_transcript is None:
        start_transcript = bool_env(
            f"FLUENT_STREAM_TRANSCRIPT{suffix}",
    ...
    # Do not echo connection details sourced from .env into transcripts or
    # launch logs.  The server identifier is sufficient operational evidence.
