...
def parse_parallel_connectivity_roster(text: str) -> dict[str, Any]:
    """Parse Fluent's parallel connectivity table without confusing cores and nodes."""
...
def require_live_compute_node_count(
    solver: Any, expected: int
) -> dict[str, Any]:
    """Fail closed unless Fluent's live connectivity roster has ``expected`` nodes."""
