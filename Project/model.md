...
- **Geometry and mesh:** the 03A full-geometry branch uses the explicitly
  ...
  [03A setup source](experiments/full-geometry-03a-mixture-08b-parity-baseline/setup-source.md)). Mesh identity and
...
- **Outlet role:** the simplified Purnanto reference has a steam pressure
  ...
  source](experiments/full-geometry-03a-mixture-08b-parity-baseline/setup-source.md)).
