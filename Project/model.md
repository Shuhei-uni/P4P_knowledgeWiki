...
- **Separator context:** the research concerns a vertical BOC separator, with
  ...
  interpretation](experiments/phase-02-parity-reset-and-pre-v2-qualification/purnanto-08c-inlet-loading-sensitivity/inlet-regimes-interpretation.md)).
- **Reference carrier stack:** the audited Purnanto reference uses a steady
  ...
  experiment](experiments/phase-01-purnanto-baseline-and-inlet-exploration/purnanto-00a-live-setup-audit/setup.md); [live
  readback](experiments/phase-01-purnanto-baseline-and-inlet-exploration/purnanto-00a-live-setup-audit/technical-live-setup-reference.md)).
...
- **Geometry and mesh:** the 03A full-geometry branch uses the explicitly
  ...
  [03A setup source](experiments/phase-05-full-geometry-v2/full-geometry-03a-mixture-08b-parity-baseline/setup-source.md)). Mesh identity and
...
- **Phases and materials:** the carrier represents primary water vapour and
  ...
  reference](experiments/phase-01-purnanto-baseline-and-inlet-exploration/purnanto-00a-live-setup-audit/technical-live-setup-reference.md)).
- **Outlet role:** the simplified Purnanto reference has a steam pressure
  ...
  source](experiments/phase-05-full-geometry-v2/full-geometry-03a-mixture-08b-parity-baseline/setup-source.md)).
- **DPM role:** DPM is reserved for entrained fine mist, provisionally
  ...
  interpretation](experiments/phase-03-dpm-carryover-and-coupling/purnanto-09cV3-fine-mist-psd/fine-mist-interpretation.md)).
