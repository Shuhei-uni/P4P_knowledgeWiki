> **Retired source:** Setups/reports/full-geometry/mixture/steady-liquid-outlet/03a/03a-08b-stage2-N5-results.md
...
|---|---:|---|---|---|
| Standard bootstrap | +500, ending at Fluent iteration 1500 | Case/data pair present | `RUN_COMPLETED_ENDPOINT_VERIFIED` | standard journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/03A-S2-N5-standard-from-i1000-plus500-20260817T125355Z.jou`; not migrated), standard residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-standard-bootstrap-residual-check.json`; not migrated) |
| Restored RNG return | +300, ending at Fluent iteration 1800 | Case/data pair present | `RUN_COMPLETED_ENDPOINT_VERIFIED` | RNG return journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/03A-S2-N5-rng-return-plus300-20260817T125355Z.jou`; not migrated), RNG return residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-rng-return-residual-check.json`; not migrated) |
| RNG +700 continuation | Requested +700 from iteration 1800, expected endpoint 2500 | Local +700 post-processing record not present | `SUBMITTED_NATIVE_RUN` in the last persisted campaign record | extension journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/03A-S2-N5-from-rng-return-plus700-20260817T132736Z.jou`; not migrated), campaign record (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/campaign-live.json`; not migrated) |
...
![N5 available recorded scaled residual history](figures/branches/N5/N5-full-scaled-residuals.png)

[Open the N5 available scaled-residual figure](figures/branches/N5/N5-full-scaled-residuals.png)
...
- N5 branch summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N5/N5-summary.json`; not migrated)
- [N5 available scaled-residual figure](figures/branches/N5/N5-full-scaled-residuals.png)
- N5 standard-bootstrap residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-standard-bootstrap-residual-check.json`; not migrated)
- N5 restored-RNG residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-rng-return-residual-check.json`; not migrated)
- N5 standard-bootstrap flux evidence (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-standard-bootstrap-flux-check.json`; not migrated)
- N5 restored-RNG flux evidence (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N5-rng-return-flux-check.json`; not migrated)
- N5 extension journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/03A-S2-N5-from-rng-return-plus700-20260817T132736Z.jou`; not migrated)
- N5 extension campaign record (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/campaign-live.json`; not migrated)
