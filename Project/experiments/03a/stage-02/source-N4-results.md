> **Retired source:** Setups/reports/full-geometry/mixture/steady-liquid-outlet/03a/03a-08b-stage2-N4-results.md
...
|---|---:|---|---|---|
| Initial screen | +300, ending at Fluent iteration 1300 | Paired case/data endpoint present | `RUN_COMPLETED_ENDPOINT_VERIFIED` | initial journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/03A-S2-N4-from-i1000-plus300-20260817T125355Z.jou`; not migrated), initial residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N4-initial-screen-residual-check.json`; not migrated) |
| Extension | Requested +700 from the N4 +300 endpoint | Paired `plus700` case/data was loaded for the local flux snapshot | `ENDPOINT_PRESENT_AFTER_NATIVE_EXCEPTION` | extension journal (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/03A-S2-N4-from-initial-screen-plus700-20260817T132736Z.jou`; not migrated), run record (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/N4-extension-700-run.json`; not migrated) |
...
![N4 available recorded scaled residual history](figures/branches/N4/N4-full-scaled-residuals.png)

[Open the N4 available scaled-residual figure](figures/branches/N4/N4-full-scaled-residuals.png)
...
The endpoint flux snapshot is in N4 extension flux-check.json (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/post_simulation_analysis/N4-extension-700-flux-check.json`; not migrated). Its load record reports `paired-read_case_data` and matching case/data names, but the final gRPC readback status remains pending.
...
- N4 branch summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N4/N4-summary.json`; not migrated)
- [N4 available scaled-residual figure](figures/branches/N4/N4-full-scaled-residuals.png)
- N4 initial residual history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T125355Z/run/post_simulation_analysis/N4-initial-screen-residual-check.json`; not migrated)
- N4 extension residual artifact (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/post_simulation_analysis/N4-extension-700-residual-check.json`; not migrated)
- N4 extension monitor history (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/post_simulation_analysis/N4-extension-700-monitor-history.json`; not migrated)
- N4 extension flux evidence (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/post_simulation_analysis/N4-extension-700-flux-check.json`; not migrated)
- N4 extension run record (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/extension-700/N4-extension-700-run.json`; not migrated)
