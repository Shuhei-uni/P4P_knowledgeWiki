...
- NP-DT1 native journal (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage3_NP-DT1_200step.jou`; not migrated)
- NP-DT1 result manifest (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage3_NP-DT1_200step_20260817.json`; not migrated)
- [Stage-3 setup plan](setup.md)
