...
1. [Stages 1–2 — Steady Parent and Transient Start States](stages-01-02-setup.md)
2. [Stage 3 — Initialization Comparison](stage-03/setup.md)
3. [Stage 4 — Transient Numerical Qualification](stage-04/setup.md)
4. [Stage 5 — Outlet-Family Compatibility Preflight](stage-05/setup.md)
5. [Stage 6 — Six-Case Aggressive Retention Screen](stage-06/setup.md)
