...
- Stage-2 build manifest (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage2_start_states_20260816.json`; not migrated)
- [Stage-2 builder](../../../../PyAnsys/scripts/setup/build_fg_mix_t01_stage2_start_states.py)
- [Stage-1 candidate report](../stage-01/results.md)
- [Stage-1/2 setup definition](../stages-01-02-setup.md)
...
record](../stage-03/results-initialization-comparison.md).
