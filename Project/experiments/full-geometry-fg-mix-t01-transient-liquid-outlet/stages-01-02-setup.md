...
The executed quick candidate screen is documented in the [Stage-1 candidate report](stage-01/results.md). It provisionally selects the `1.1375 MPa` endpoint as the candidate parent for the next setup-construction stage; this selection is diagnostic and conditional on the Stage-2 readback gate because the 1,000-iteration field is not converged.
...
Proceed to [Stage 3 — Initialization Comparison](stage-03/setup.md).
