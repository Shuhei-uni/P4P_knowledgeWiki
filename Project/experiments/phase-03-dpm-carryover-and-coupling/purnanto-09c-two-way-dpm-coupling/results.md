> **Retired source:** Setups/reports/purnanto-reference/09c/results.md
...
- Setup definition: [09c-dpm-ewf-wall-film-reentrainment.md](setup.md)
...
Residual plot: 09c residual history (historical machine artifact path: `../../../PyAnsys/output/live_postprocess_20260720/09c-residuals_20260720_132009.png`; not migrated)

Machine-readable post-processing: 09c summary (historical machine artifact path: `../../../PyAnsys/output/live_postprocess_20260720/09c-summary.json`; not migrated)
