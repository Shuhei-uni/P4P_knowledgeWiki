...
| Child setups | [09cV3 — fine-mist 5% DPM PSD rerun](../purnanto-09cV3-fine-mist-psd/setup.md); [010V2](../../phase-04-ewf-wall-film-mechanisms/purnanto-010V2-clean-ewf-deposition/setup.md) |
...
Use the accepted `09cV2` case/data pair and its selected fraction point to create [010V2 — EWF deposition and film inventory](../../phase-04-ewf-wall-film-mechanisms/purnanto-010V2-clean-ewf-deposition/setup.md). Do not promote the 5% point to a physical default without a closed Skoog/1-D balance or new measurement evidence.
...
| Verification | strict post-save readback (historical machine artifact path: `../../../PyAnsys/output/09cV2_student_velocity_inlet_adaptation_verification_20260804.json`; not migrated) |
...
- [09c parent setup](../purnanto-09c-two-way-dpm-coupling/setup.md)
