...
- Next action: create the two named inlet faces from `../purnanto-06-pure-phase-fixed-velocity/setup.md`, then verify Fluent flux reports before interpreting outlet behavior.
