# P7-E5-CZ-G100 — native lower-cell-zone source, G=1.00
...
| Controlled delta | Native lower-zone phase-2 mass source plus audited mixture momentum source, gain `G=1.00` |
...
u       = clamp(1.00 × 116.92 kg/s × e, 0, 146.15 kg/s)
S_mass  = -u / V_lower
