# P7-E5-CZ-G050 — native lower-cell-zone source, G=0.50
...
| Controlled delta | Native lower-zone phase-2 mass source plus audited mixture momentum source, gain `G=0.50` |
...
u       = clamp(0.50 × 116.92 kg/s × e, 0, 146.15 kg/s)
S_mass  = -u / V_lower
