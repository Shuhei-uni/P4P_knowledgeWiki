# E6 outer-ring pressure outlet — P1200

## Setup identity

- **Setup ID:** `P7-E6-RING-OUTER-PO-P1200`
- **Candidate:** `E6-RING-PO`
- **Role:** discovery child, outermost radial band pressure outlet
- **Status:** `DESIGN_READY_NOT_PLACED`
- **Controlled pressure:** `1.200 MPa` gauge on `p7-bottom-ring-r05-outer`
...
state first, set the R05 gauge pressure to `1,200,000 Pa` last, and prove the
requested state before save and after reopen. Run the 50-iteration smoke gate
before the 500-iteration discovery horizon. The corrected full-bottom E1 P1200
