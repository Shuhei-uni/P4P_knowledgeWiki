# P7-E5-CZ-ABSORB-G200-CAP58460 setup

## Status and authority

| Field | Contract |
| --- | --- |
| Status | BLOCKED_VERIFIED — corrected rerun diverged during the block ending at active 450; valid evidence through active 400 is recorded in [results.md](results.md) |
...
- requested command: Q = clamp(2.00 × 116.92 kg/s × e_L, 0, 584.60 kg/s);
