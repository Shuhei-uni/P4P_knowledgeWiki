# P7-E5-CZ-ABSORB-G200-CAP14615 setup

## Status and authority

| Field | Contract |
| --- | --- |
| Status | COMPLETE_VERIFIED — 500 active iterations completed; bounded result recorded in [results.md](results.md) |
...
- requested command: Q = clamp(2.00 × 116.92 kg/s × e_L, 0, 146.15 kg/s);
