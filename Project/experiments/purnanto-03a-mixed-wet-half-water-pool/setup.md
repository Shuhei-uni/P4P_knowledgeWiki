> **Retired source:** Setups/past/archived/03a-mixed-wet-half-velocity-inlet-water-pool.md
...
| Setup ID | `03a` |
| Lifecycle | `archived` |
| Role | initialized-water-pool diagnostic child |
| Parent setup | [03](../purnanto-03-mixed-wet-half-velocity-inlet/setup.md) |
| Evidence-use label | non-physical diagnostic run; no efficiency/DPM report |
| Outcome | rejected |
| Linked report | none |
...
- [03-mixed-wet-half-velocity-inlet.md](../purnanto-03-mixed-wet-half-velocity-inlet/setup.md)
