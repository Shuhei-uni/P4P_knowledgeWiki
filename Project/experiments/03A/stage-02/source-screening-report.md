> **Retired source:** Setups/reports/full-geometry/mixture/steady-liquid-outlet/03a/03a-08b-stage2-screening-report.md
...
![Four-branch direct scaled residual overview](figures/overview/stage2-full-scaled-residual-overview.png)

[Open the four-branch scaled-residual overview](figures/overview/stage2-full-scaled-residual-overview.png)
...
![Compact phase-flux comparison](figures/overview/stage2-phase-flux-overview.png)

[Open the phase-flux overview](figures/overview/stage2-phase-flux-overview.png)
...
![Compact mass-balance comparison](figures/overview/stage2-mass-balance-overview.png)

[Open the mass-balance overview](figures/overview/stage2-mass-balance-overview.png)
...
- [N1 results](source-N1-results.md)
- [N3 results](source-N3-results.md)
- [N4 results](source-N4-results.md)
- [N5 results](source-N5-results.md)

## Analysis artifacts

- overview JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/overview/stage2-overview.json`; not migrated)
- N1 summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N1/N1-summary.json`; not migrated)
- N3 summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N3/N3-summary.json`; not migrated)
- N4 summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N4/N4-summary.json`; not migrated)
- N5 summary JSON (historical machine artifact path: `../../../../PyAnsys/output/03a_stage2/20260817T132736Z/report/N5/N5-summary.json`; not migrated)
