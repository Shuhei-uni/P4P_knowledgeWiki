...
- carrier flux extraction (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-B-brine-p1120kpa-unprimed-iter500-flux-check.json`; not migrated)
- residual history (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-B-brine-p1120kpa-unprimed-iter500-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-B-brine-p1120kpa-unprimed-iter500-residual-check.png`; not migrated)
- configuration audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-B-iter500-audit/model_audit.json`; not migrated)
- complete DPM output bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-B-iter500-dpm/raw_results.json`; not migrated), including per-injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-B-iter500-dpm/dpm_injection_summary.csv`; not migrated) and zone fate rows (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-B-iter500-dpm/dpm_zone_summary.csv`; not migrated)
...
- carrier flux extraction (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-A-brine-p1115kpa-unprimed-iter649-flux-check.json`; not migrated)
- residual history (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-A-brine-p1115kpa-unprimed-iter649-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-A-brine-p1115kpa-unprimed-iter649-residual-check.png`; not migrated)
- configuration audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-A-iter649-audit/model_audit.json`; not migrated)
- complete DPM output bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-A-iter649-dpm/raw_results.json`; not migrated), including per-injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-A-iter649-dpm/dpm_injection_summary.csv`; not migrated), zone fate rows (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-A-iter649-dpm/dpm_zone_summary.csv`; not migrated), and the full transcript (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-A-iter649-dpm/dpm_particle_track_transcript.txt`; not migrated).
...
- carrier flux extraction (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-C-brine-p1125kpa-unprimed-iter500-flux-check.json`; not migrated)
- residual history (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-C-brine-p1125kpa-unprimed-iter500-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-C-brine-p1125kpa-unprimed-iter500-residual-check.png`; not migrated)
- configuration audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-C-iter500-audit/model_audit.json`; not migrated)
- complete DPM output bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-C-iter500-dpm/raw_results.json`; not migrated), per-injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-C-iter500-dpm/dpm_injection_summary.csv`; not migrated), zone fate rows (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-C-iter500-dpm/dpm_zone_summary.csv`; not migrated), and full transcript (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-C-iter500-dpm/dpm_particle_track_transcript.txt`; not migrated).
...
Post-processing artifacts: flux JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-D-brine-p1122p5kpa-unprimed-iter500-flux-check.json`; not migrated), residual JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-D-brine-p1122p5kpa-unprimed-iter500-residual-check.json`; not migrated), residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-D-brine-p1122p5kpa-unprimed-iter500-residual-check.png`; not migrated), model audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/model_audit.json`; not migrated), and DPM bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/raw_results.json`; not migrated) with injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/dpm_injection_summary.csv`; not migrated) and zone summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/dpm_zone_summary.csv`; not migrated).
...
Post-processing artifacts: flux JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-E-brine-p1127p5kpa-unprimed-iter500-flux-check.json`; not migrated), residual JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-E-brine-p1127p5kpa-unprimed-iter500-residual-check.json`; not migrated), residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-E-brine-p1127p5kpa-unprimed-iter500-residual-check.png`; not migrated), model audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/model_audit.json`; not migrated), and DPM bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/raw_results.json`; not migrated) with injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/dpm_injection_summary.csv`; not migrated) and zone summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/dpm_zone_summary.csv`; not migrated).
...
Post-processing artifacts: flux JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-F-brine-p1130kpa-unprimed-iter500-flux-check.json`; not migrated), residual JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-F-brine-p1130kpa-unprimed-iter500-residual-check.json`; not migrated), residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-F-brine-p1130kpa-unprimed-iter500-residual-check.png`; not migrated), model audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/model_audit.json`; not migrated), and DPM bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/raw_results.json`; not migrated) with injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/dpm_injection_summary.csv`; not migrated) and zone summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/dpm_zone_summary.csv`; not migrated).
...
Post-processing artifacts: flux JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-G-brine-p1135kpa-unprimed-iter500-flux-check.json`; not migrated), residual JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-G-brine-p1135kpa-unprimed-iter500-residual-check.json`; not migrated), residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-G-brine-p1135kpa-unprimed-iter500-residual-check.png`; not migrated), model audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/model_audit.json`; not migrated), and DPM bundle (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/raw_results.json`; not migrated) with injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/dpm_injection_summary.csv`; not migrated) and zone summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/dpm_zone_summary.csv`; not migrated).
...
Post-processing artifacts: Student build manifest (historical machine artifact path: `../../../PyAnsys/output/02c-student-h1140-build-20260816T091723Z.json`; not migrated), carrier flux JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z-flux-check.json`; not migrated), residual JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z-residual-check.json`; not migrated), residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z-residual-check.png`; not migrated), native journal (historical machine artifact path: `../../../PyAnsys/output/02c-student-h1140-run-20260816T091812Z.jou`; not migrated).
...
|---|---|---|---|---|---|
| D | `02c-D-...-iter500-20260813T205605Z.cas.h5/.dat.h5` | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-D-brine-p1122p5kpa-unprimed-iter500-flux-check.json`; not migrated) | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-D-brine-p1122p5kpa-unprimed-iter500-residual-check.json`; not migrated) | audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/model_audit.json`; not migrated) | raw (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-D-iter500-dpm/raw_results.json`; not migrated) |
| E | `02c-E-...-iter500-20260813T205605Z.cas.h5/.dat.h5` | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-E-brine-p1127p5kpa-unprimed-iter500-flux-check.json`; not migrated) | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-E-brine-p1127p5kpa-unprimed-iter500-residual-check.json`; not migrated) | audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/model_audit.json`; not migrated) | raw (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-E-iter500-dpm/raw_results.json`; not migrated) |
| F | `02c-F-...-iter500-20260813T205605Z.cas.h5/.dat.h5` | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-F-brine-p1130kpa-unprimed-iter500-flux-check.json`; not migrated) | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-F-brine-p1130kpa-unprimed-iter500-residual-check.json`; not migrated) | audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/model_audit.json`; not migrated) | raw (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-F-iter500-dpm/raw_results.json`; not migrated) |
| G | `02c-G-...-iter500-20260813T205605Z.cas.h5/.dat.h5` | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-G-brine-p1135kpa-unprimed-iter500-flux-check.json`; not migrated) | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-G-brine-p1135kpa-unprimed-iter500-residual-check.json`; not migrated) | audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/model_audit.json`; not migrated) | raw (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/02c-G-iter500-dpm/raw_results.json`; not migrated) |
| H | `02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z.cas.h5/.dat.h5` | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z-flux-check.json`; not migrated) | JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/02c-H-brine-p1140kpa-unprimed-student-iter500-20260816T091812Z-residual-check.json`; not migrated) | Student endpoint reload: viscosity limiting; no DPM/EWF claim | — |
