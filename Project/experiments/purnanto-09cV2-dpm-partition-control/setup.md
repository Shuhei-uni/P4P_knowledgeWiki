...
Use the accepted `09cV2` case/data pair and its selected fraction point to create [010V2 — EWF deposition and film inventory](../purnanto-010V2-clean-ewf-deposition/setup.md). Do not promote the 5% point to a physical default without a closed Skoog/1-D balance or new measurement evidence.
