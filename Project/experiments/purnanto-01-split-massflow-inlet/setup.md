> **Retired source:** Setups/past/archived/01-split-two-zone-massflow-inlet.md
...
| Setup ID | `01` |
| Lifecycle | `archived` |
| Role | first split-inlet concept branch |
| Parent setup | [00](../purnanto-00-reference-spiral-boc/setup.md) |
...
The aim is to keep the Fluent setup as close as possible to [00-baseline-spiral-boc-reference.md](../purnanto-00-reference-spiral-boc/setup.md), which you have clarified is the **spiral-inlet** baseline report, while changing only what is required to represent a segregated two-phase inlet.
