...
![Recovered Setup 02e Stage-2 Y010 and Y030 liquid inventory histories](figures/02e_stage2_inventory_histories_20260816.png)

![Recovered Setup 02e Stage-2 Y010 and Y030 liquid mass histories](figures/02e_stage2_mass_inventory_histories_20260816.png)
...
![Setup 02e Stage-2 native Fluent scaled residual histories](figures/02e_stage2_scaled_residuals_20260816.png)
...
- Native run manifests: `PO-S2-A manifest` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_native_po_s2_a_20260816T171000Z.json`; not migrated), `PO-S2-B manifest` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_native_po_s2_b_20260816T172000Z.json`; not migrated), `OV-S2-A manifest` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_native_ov_s2_a_20260816T173000Z.json`; not migrated), `OV-S2-B manifest` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_native_ov_s2_b_20260816T174500Z.json`; not migrated)
- Recovered native histories, transcripts, and generated summary: `02e_stage2_recovered_20260816` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_recovered_20260816`; not migrated)
- Machine-readable summary: `02e_stage2_inventory_flux_summary_20260816.json` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_recovered_20260816/02e_stage2_inventory_flux_summary_20260816.json`; not migrated)
- Compact summary CSV: `02e_stage2_inventory_flux_summary_20260816.csv` (historical machine artifact path: `../../../../PyAnsys/output/02e_stage2_recovered_20260816/02e_stage2_inventory_flux_summary_20260816.csv`; not migrated)
