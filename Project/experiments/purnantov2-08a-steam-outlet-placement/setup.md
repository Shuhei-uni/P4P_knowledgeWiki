...
| Setup ID | `08a` |
| Lifecycle | `archived` |
| Role | parked outlet-boundary-placement trial |
| Parent setup | [07](../purnanto-07-pure-phase-actual-area/setup.md) |
| Evidence-use label | planned; result fields pending |
| Outcome | parked |
| Linked report | none |
...
- [07-pure-phase-split-actual-area.md](../purnanto-07-pure-phase-actual-area/setup.md)
