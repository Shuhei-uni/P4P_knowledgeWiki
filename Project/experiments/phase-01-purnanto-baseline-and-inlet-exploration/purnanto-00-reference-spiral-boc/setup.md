...
| Setup ID | `00` |
| Lifecycle | `archived` |
| Role | paper/reference baseline |
| Parent setup | none |
| Evidence-use label | reference setup definition; no project result report |
| Outcome | retained for lineage |
| Linked report | [technical extraction](technical-extraction.md) |
