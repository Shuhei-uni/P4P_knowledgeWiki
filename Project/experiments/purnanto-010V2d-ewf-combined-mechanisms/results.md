> **Legacy source:** Setups/reports/purnanto-reference/010V2d/results.md  
...
| DPM fate analysis | completed | All six live `water-liquid-at-psep-*` injections passed the transcript completion gate; per-injection raw summaries (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2d-server1-20260723-5000-dpm/dpm_raw`; not migrated) are retained. |
...
| DPM fate analysis | completed | All six live `water-liquid-at-psep-*` injections passed the transcript completion gate; per-injection raw summaries (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2d-server1-20260724-10000-dpm/dpm_raw`; not migrated) are retained. |
