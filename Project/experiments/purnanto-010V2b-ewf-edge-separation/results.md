> **Retired source:** Setups/reports/purnanto-reference/010V2b/results.md
...
- Setup definition: [010V2b — EWF Edge-Separation Sensitivity](setup.md)
- Parent setup: [010V2 — EWF deposition and film-inventory control](../purnanto-010V2-clean-ewf-deposition/setup.md)
...
- EWF/DPM live audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-audit-20260722/model_audit.json`; not migrated)
- Audit run manifest (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-audit-20260722/run_manifest.json`; not migrated)
- Audit raw results (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-audit-20260722/raw_results.json`; not migrated)
- Audit bookkeeping payload (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-audit-20260722/bookkeeping.json`; not migrated)
...
- Retry EWF/DPM audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-retry-audit-20260722/model_audit.json`; not migrated)
- Retry audit run manifest (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-retry-audit-20260722/run_manifest.json`; not migrated)
- Carrier flux check (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-retry-20260722-flux-check.json`; not migrated)
- Residual check (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-retry-20260722-residual-check.json`; not migrated)
- Residual-history plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-retry-20260722-residual-check.png`; not migrated)
...
- Server-3 EWF/DPM audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-audit-20260723-r2/model_audit.json`; not migrated)
- EWF final reports (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-snapshot-20260723-r2/final_reports.csv`; not migrated), film-boundary fluxes (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-snapshot-20260723-r2/film_flux.csv`; not migrated), and snapshot raw results (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-snapshot-20260723-r2/raw_results.json`; not migrated)
- DPM injection summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-dpm-20260723-r2/dpm_injection_summary.csv`; not migrated), zone/mass-flow summary (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-dpm-20260723-r2/dpm_zone_summary.csv`; not migrated), and complete DPM transcript (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-dpm-20260723-r2/dpm_particle_track_transcript.txt`; not migrated)
- 348.88 µm raw DPM report (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-5000-dpm-20260723-r2/dpm_raw/03-water-liquid-at-psep-348um.txt`; not migrated)
- Carrier flux check (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-5000-20260723-flux-check.json`; not migrated), residual check (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-5000-20260723-residual-check.json`; not migrated), and residual plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2b-5000-20260723-residual-check.png`; not migrated)
...
**Raw evidence:** audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-server3-20260727-4999-audit`; not migrated), EWF final-state snapshot (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-server3-20260727-4999-snapshot`; not migrated), and completed six-injection DPM sweep (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2b-server3-20260727-4999-dpm`; not migrated). The audit confirms global DPM interaction `Off`, unsteady tracking `Off`, and maximum DPM steps `10000`. The 2024 R2 Settings API does not expose the top-level EWF branch or a readable wall separation flag; this is an adapter limitation, not proof that edge separation is disabled.
