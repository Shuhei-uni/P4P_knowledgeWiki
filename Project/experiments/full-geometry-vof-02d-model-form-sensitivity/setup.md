...
The comparable Mixture control is setup `02c`, particularly its unprimed baseline at equal brine and steam-outlet gauge pressures. The historical VOF side branch [02b](../purnanto-02b-vof-split-inlet-transient/setup.md) remains archived as an invalid qualitative run; it is context only and must not be overwritten, treated as a parent artifact, or used as numerical evidence.
