> **Retired source:** Setups/reports/purnanto-reference/010V2a/results.md
...
- Setup definition: [010V2a — EWF Splash Sensitivity](setup.md)
...
- Flux check JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-flux-check.json`; not migrated)
- Residual check JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-residual-check.json`; not migrated)
- Residual history plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-residual-check.png`; not migrated)
- DPM Particle Tracks Summary JSON (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-dpm-particle-track-summary.json`; not migrated)
- DPM Particle Tracks Summary CSV (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-dpm-particle-track-summary.csv`; not migrated)
- DPM Particle Tracks transcript (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-ewf-splash-dpm-particle-track-transcript.txt`; not migrated)
- EWF/DPM model audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-ewf-splash/model_audit.json`; not migrated)
- EWF final-state raw results (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-ewf-splash-snapshot/raw_results.json`; not migrated)
- EWF bookkeeping snapshot (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-ewf-splash-snapshot/bookkeeping.json`; not migrated)
...
- **Raw evidence:** audit (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-server2-20260724-5000-audit`; not migrated), EWF final-state snapshot (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-server2-20260724-5000-snapshot`; not migrated), completed six-injection DPM sweep (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-server2-20260724-5000-dpm`; not migrated), carrier flux check (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-server2-20260724-5000-flux-check.json`; not migrated), and residual history (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-server2-20260724-5000-residual-check.json`; not migrated) (plot (historical machine artifact path: `../../../PyAnsys/output/post_simulation_analysis/010V2a-server2-20260724-5000-residual-check.png`; not migrated)).
...
| DPM fate analysis | completed | All six live `water-liquid-at-psep-*` injections passed the transcript completion gate; per-injection raw summaries (historical machine artifact path: `../../../PyAnsys/output/ewf_dpm_diagnostics/010V2a-server2-20260724-5000-dpm/dpm_raw`; not migrated) are retained. |
