...
This is a discovery run. It is a partial repeat of the prior 25%-start,
2,000-iteration inlet ramp, with the controlled delta being the verified v2
60k mesh and feed-forward virtual-outlet absorber.
