...
> **Status — DEFFERED (2026-09-22):** The Server-3 C8 approach was paused
> before qualification. Preserve this record as historical planning
> provenance; use `results-v2-corrected-absorber.md` for the bounded paused
> v2 evidence.
