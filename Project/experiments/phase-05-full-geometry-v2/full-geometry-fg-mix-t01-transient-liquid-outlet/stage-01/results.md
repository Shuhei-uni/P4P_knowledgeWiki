...
- Parent contract: [02c Mixture brine-outlet pressure sensitivity, unprimed](../../../phase-02-parity-reset-and-pre-v2-qualification/full-geometry-02c-mixture-pressure-sensitivity/setup.md)
...
The case-only build snapshot is fg_mix_t01_stage1_candidates_20260816T102830Z.json (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_candidates_20260816T102830Z.json`; not migrated).
...
- `C136`: manifest (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C136_20260816T103114Z.json`; not migrated), journal (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C136_20260816T103114Z.jou`; not migrated)
- `C1375`: manifest (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C1375_20260816T104203Z.json`; not migrated), journal (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C1375_20260816T104203Z.jou`; not migrated)
- `C139`: manifest (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C139_20260816T105250Z.json`; not migrated), journal (historical machine artifact path: `../../../../PyAnsys/output/fg_mix_t01_stage1_C139_20260816T105250Z.jou`; not migrated)
...
- C136 residual JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C136-iter1000-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C136-iter1000-residual-check.png`; not migrated)
- C1375 residual JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C1375-iter1000-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C1375-iter1000-residual-check.png`; not migrated)
- C139 residual JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C139-iter1000-residual-check.json`; not migrated) and plot (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C139-iter1000-residual-check.png`; not migrated)
...
- C136 flux JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C136-iter1000-flux-check.json`; not migrated)
- C1375 flux JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C1375-iter1000-flux-check.json`; not migrated)
- C139 flux JSON (historical machine artifact path: `../../../../PyAnsys/output/post_simulation_analysis/FG-MIX-T01-S1-C139-iter1000-flux-check.json`; not migrated)
