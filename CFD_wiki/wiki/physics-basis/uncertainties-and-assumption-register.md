...
| Incomplete DPM tracks | Purnanto reports incomplete tracks remained significant | A single DPM efficiency number may be misleading if incomplete counts are large | High | Tracking-step, mesh, and time-sensitivity checks; report optimistic/pessimistic brackets | Low incomplete fraction with stable efficiency under sensitivity |
